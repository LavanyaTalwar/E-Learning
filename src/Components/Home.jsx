...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen bg-[#ECEDDD]'>

      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <p className='text-pink-600'>Check the Courses</p>
        <h1 className='text-4xl sm:text-7xl font-bold text-[#010101]'>
          <Typewriter
            options={{ autoStart: true, loop: true, delay: 100, strings: ['React JS', 'DSA', 'Java', 'Python'] }}
          />
        </h1>

        <p className='text-[#010101] py-4 max-w-[700px]'>
        ...
        <div className='w-full  grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
              ...
              <p className='my-4 text-black text-2xl'>HTML</p>
          </div>
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src={CSS} alt="HTML icon" />
              <p className='my-4 text-black text-2xl'>CSS</p>
          </div>
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src={JavaScript} alt="HTML icon" />
              <p className='my-4 text-black text-2xl'>JAVASCRIPT</p>
          </div>
